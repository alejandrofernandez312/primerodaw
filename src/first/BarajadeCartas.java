...
public class BarajadeCartas {
	...
	public static void main(String[] args) {
		...
		String[] barajabarajada = barajarbaraja(barajaconpalos(barajanueva));
		...
		do {
			...
			case 2:
				...
				break;
			case 3:
				System.out.println("Esta es la baraja barajada");
				System.out.println();
				printbaraja(barajabarajada);
				break;
			}
		} while (op != 4);
	...
	public static String[] barajarbaraja(String[] array) {
		String[] barajabarajada = new String[40];
	...
	public static void menu() {
		...
		System.out.println("3.-Ver baraja barajada");
